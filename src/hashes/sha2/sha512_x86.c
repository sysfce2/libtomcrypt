...
#include <immintrin.h> /* AVX    _mm256_castsi128_si256 _mm256_castsi256_si128 _mm256_load_si256 _mm256_loadu_si256 _mm256_storeu_si256
                          AVX2   _mm256_add_epi64 _mm256_blend_epi32 _mm256_permute4x64_epi64 _mm256_shuffle_epi8
                          SHA512 _mm256_sha512msg1_epi64 _mm256_sha512msg2_epi64 _mm256_sha512rnds2_epi64 */
#if defined(__GNUC__)
...
#define any 0
    ...
    state_a = _mm256_loadu_si256(((__m256i const*)(&md->sha512.state[0])));
    state_b = _mm256_loadu_si256(((__m256i const*)(&md->sha512.state[4])));
...
/* compress 1024-bits */
#ifdef LTC_CLEAN_STACK
static int s_sha512_x86_compress(hash_state * md, const unsigned char *buf)
{
    int err;
    err = ss_sha512_x86_compress(md, buf);
